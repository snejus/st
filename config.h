 ...
 */
static char *font = "Iosevka Fixed:size=11:antialias=true:autohint=true";
...
/*     "#212733",  /1* dark grey - background *1/ */
/*     "#ff557f",  /1* dim red *1/ */
/*     "#a7cd81",  /1* dim green *1/ */
/*     "#edb879",  /1* dim yellow *1/ */
/*     "#6495ed",  /1* dim blue *1/ */
/*     "#8e6ebc",  /1* dim magenta *1/ */
/*     "#87ceeb",  /1* dim cyan *1/ */
/*     "#ffffff",  /1* white *1/ */
/* }; */
static const char *colorname[] = {
